...
rm -rf feeds/small8/luci-app-openvpn-server
rm -rf feeds/small8/openvpn-easy-rsa-whisky
rm -rf feeds/small8/luci-app-wrtbwmon
rm -rf feeds/small-package/wrtbwmon
# rm -rf package/small-package/luci-app-koolproxyR
# rm -rf package/small-package/luci-app-godproxy
rm -rf feeds/small8/luci-app-argon*
rm -rf feeds/small8/luci-theme-argon*
# rm -rf package/small-package/luci-app-amlogic
rm -rf feeds/small8/luci-app-unblockneteasemusic
rm -rf feeds/small8/upx-static
rm -rf feeds/small8/upx
# rm -rf feeds/small-package/firewall*
rm -rf feeds/small8/opkg

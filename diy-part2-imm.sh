...
sed -i 's#https://github.com/breakings/OpenWrt#https://github.com/hangyubin/Actions_OpenWrt-Amlogic#g' package/luci-app-amlogic/luci-app-amlogic/root/etc/config/amlogic
